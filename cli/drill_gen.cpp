...
// Derived in cli/keystrokes.h, shared with the tutorial audit so the
// drills and the lessons prescribe the same fastest keystrokes.
using mspy_cli::Accepted;
using mspy_cli::KeysForSyllable;
using mspy_cli::ToneKeyFor;
